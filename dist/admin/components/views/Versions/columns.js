...
export const getColumns = (collection, global, t) => [
    {
        accessor: 'updatedAt',
        components: {
            Heading: (React.createElement(SortColumn, { label: t('general:updatedAt'), name: "updatedAt" })),
    ...
    },
    {
        accessor: 'id',
        components: {
            Heading: (React.createElement(SortColumn, { label: t('versionID'), disable: true, name: "id" })),
    ...
    },
    {
        accessor: 'autosave',
        components: {
            Heading: (React.createElement(SortColumn, { label: t('type'), name: "autosave", disable: true })),
            renderCell: (row) => (React.createElement(TextCell, null,
                (row === null || row === void 0 ? void 0 : row.autosave) && (React.createElement(React.Fragment, null,
                    React.createElement(Pill, null, t('autosave')),
                    "\u00A0\u00A0")),
                (row === null || row === void 0 ? void 0 : row.version._status) === 'published' && (React.createElement(React.Fragment, null,
                    React.createElement(Pill, { pillStyle: "success" }, t('published')),
                    "\u00A0\u00A0")),
                (row === null || row === void 0 ? void 0 : row.version._status) === 'draft' && (React.createElement(Pill, null, t('draft'))))),
        },
    },
];
