...
const Iterable = ({ version, comparison, permissions, field, locale, locales, fieldComponents, }) => {
    ...
    return (React.createElement("div", { className: baseClass },
        ...
        maxRows === 0 && (React.createElement("div", { className: `${baseClass}__no-rows` }, t('noRowsFound', { label: ((_a = field.labels) === null || _a === void 0 ? void 0 : _a.plural) ? getTranslation((_b = field.labels) === null || _b === void 0 ? void 0 : _b.plural, i18n) : t('general:rows') })))));
};
