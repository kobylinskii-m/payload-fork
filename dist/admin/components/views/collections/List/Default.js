...
const DefaultList = (props) => {
    ...
    return (React.createElement("div", { className: baseClass },
        React.createElement(Meta, { title: getTranslation(collection.labels.plural, i18n) }),
        ...
        React.createElement(Gutter, { className: `${baseClass}__wrap` },
            React.createElement("header", { className: `${baseClass}__header` },
                React.createElement("h1", null, getTranslation(pluralLabel, i18n)),
                hasCreatePermission && (React.createElement(Pill, { to: newDocumentURL }, t('createNew'))),
            ...
            data.docs && data.docs.length === 0 && (React.createElement("div", { className: `${baseClass}__no-results` },
                React.createElement("p", null, t('noResults', { label: getTranslation(pluralLabel, i18n) })),
                hasCreatePermission && (React.createElement(Button, { el: "link", to: newDocumentURL }, t('createNewLabel', { label: getTranslation(singularLabel, i18n) }))))),
