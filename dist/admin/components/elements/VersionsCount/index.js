...
const VersionsCount = ({ collection, global, id }) => {
    ...
    return (React.createElement("div", { className: baseClass },
        ...
        versionCount > 0 && (React.createElement(Button, { className: `${baseClass}__button`, buttonStyle: "none", el: "link", to: versionsURL }, t(versionCount === 1 ? 'versionCount_one' : 'versionCount_many', { count: versionCount })))));
};
