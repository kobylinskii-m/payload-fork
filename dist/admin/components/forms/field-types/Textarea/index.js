...
const Textarea = (props) => {
    ...
    return (React.createElement(TextareaInput, { path: path, name: name, onChange: (e) => {
        ...
        }, showError: showError, errorMessage: errorMessage, required: required, label: label, value: value, placeholder: getTranslation(placeholder, i18n), readOnly: readOnly, style: style, className: className, width: width, description: description, rows: rows }));
};
