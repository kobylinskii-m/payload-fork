...
const Code = (props) => {
    ...
    return (React.createElement("div", { className: classes, style: {
        ...
        React.createElement(Editor, { className: `${baseClass}__input`, id: `field-${path.replace(/\./gi, '__')}`, value: value || '', onValueChange: readOnly ? () => null : setValue, highlight: highlighter, padding: 25, style: {
