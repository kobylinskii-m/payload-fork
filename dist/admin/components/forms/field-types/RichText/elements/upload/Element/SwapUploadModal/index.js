...
export const SwapUploadModal = ({ closeModal, element, setRelatedCollectionConfig, relatedCollectionConfig, slug }) => {
    ...
    const [modalCollectionOption, setModalCollectionOption] = React.useState({ label: getTranslation(relatedCollectionConfig.labels.singular, i18n), value: relatedCollectionConfig.slug });
    ...
    return (React.createElement(Modal, { className: baseClass, slug: slug },
        React.createElement(MinimalTemplate, { width: "wide" },
            React.createElement("header", { className: `${baseClass}__header` },
                React.createElement("h1", null, t('chooseLabel', { label: getTranslation(modalCollection.labels.singular, i18n) })),
