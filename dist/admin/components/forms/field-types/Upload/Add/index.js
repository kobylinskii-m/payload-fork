            ...
            React.createElement(Form, { method: "post", action: `${serverURL}${api}/${collection.slug}`, onSuccess: onSuccess, disableSuccessStatus: true, validationOperation: "create" },
                React.createElement("header", { className: `${baseClass}__header` },
                    React.createElement("div", null,
                        React.createElement("h1", null, t('newLabel', { label: getTranslation(collection.labels.singular, i18n) })),
                        React.createElement(FormSubmit, null, t('general:save')),
                        React.createElement(Button, { icon: "x", round: true, buttonStyle: "icon-label", iconStyle: "with-border", onClick: () => toggleModal(slug) })),
