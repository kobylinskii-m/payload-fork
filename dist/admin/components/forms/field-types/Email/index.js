...
const Email = (props) => {
    ...
    return (React.createElement("div", { className: classes, style: {
        ...
        React.createElement("input", { id: `field-${path.replace(/\./gi, '__')}`, value: value || '', onChange: setValue, disabled: Boolean(readOnly), placeholder: getTranslation(placeholder, i18n), type: "email", name: path, autoComplete: autoComplete }),
