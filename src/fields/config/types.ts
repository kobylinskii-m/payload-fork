...
export type Validate<T = any, S = any, F = any> = (
  value?: T,
  options?: ValidateOptions<F, S, Partial<F>>
...
export type UnnamedTab = TabBase &
  Omit<FieldBase, "name"> & {
    label: Record<string, string> | string;
    localized?: never;
  };
...
export type SearchableRelationshipField = RelationshipField & {
  fields?: Field[];
};
